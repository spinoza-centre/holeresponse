...
htmlhelp_basename = 'holeresponsedoc'
...
latex_documents = [
    (master_doc, 'holeresponse.tex', 'holeresponse Documentation',
     'Jurjen Heij', 'manual'),
]
...
man_pages = [
    (master_doc, 'holeresponse', 'holeresponse Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'holeresponse', 'holeresponse Documentation',
     author, 'holeresponse', 'Repository for the Hole-Response experiment using line-scanning',
     'Miscellaneous'),
]
